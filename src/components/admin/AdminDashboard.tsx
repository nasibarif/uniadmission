...
export const AdminDashboard: React.FC = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'verificationQueue' | 'universities' | 'scholarships' | 'auditLogs' | 'payments' | 'subscriptions'>('verificationQueue');
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Sub-Tab 6: Subscriptions & Entitlements Management */}
      {activeSubTab === 'subscriptions' && (
        <div className="space-y-6 animate-in fade-in">
          {/* Metrics */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200 text-slate-600 font-bold uppercase text-[10px] tracking-wider">
                    ...
                    <th className="p-3.5">Starts At</th>
                    <th className="p-3.5">Status</th>
                    <th className="p-3.5">Entitled Features</th>
